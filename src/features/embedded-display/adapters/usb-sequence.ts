...
function encodeUsbSequencePatch(
  ...
  const patchReducesTransfer = unchanged || patchArea * 4 <= frameArea * 3;
  return patchReducesTransfer ||
    patchBytes.byteLength < fullFrame.bytes.byteLength
