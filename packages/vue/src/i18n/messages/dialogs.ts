...
export const dialogMessageDefaults = {
  ...
  designMode: 'Design',
  deviceMode: 'Device',
  describeDeviceAction: 'Describe a device deployment or check…',
  describeDeviceDeployment: 'Deploy the current Frame or check the connected device.',
  deviceModeNoReferenceImage: 'Reference images are available in Design mode',
  stopGenerating: 'Stop generating',
  sendMessage: 'Send message',
  attachReferenceImage: 'Add reference image',
  removeReferenceImage: 'Remove reference image',
  targetScreen: 'Target screen',
  roundScreen: 'Round screen',
  selectedModelNoImageSupport: 'The selected model does not support image input',
  referenceImageLimit: 'Add up to 4 reference images per message',
  baseURLPlaceholder: 'Base URL (e.g. http://localhost:11434/v1)',
  modelIDPlaceholder: 'Model ID (e.g. llama-3.3-70b)',
  aiProvider: 'AI Provider',
  aiProcess: 'Process',
  aiOperations: params('{count} ops'),
  aiToolProtocolError:
    'The model provider did not parse its tool call. Retry or select another tool-capable model.',
